...
export const mastra = new Mastra({
  workflows: { sequentialPipeline, repositoryParserWorkflow, analyzingFilesWorkflow }, //weatherWorkflow
  agents: { repoAnalyst, IdentifyAbstractionAgent, analyseRelationsAgent, OrderChaptersAgent, WriteChapterAgent, analyseFileAgent, repositoryParserAgent, AnalyzingFilesAgent }, //weatherAgent
